...
public class BlankFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView listView = (ListView) v.findViewById(R.id.listView4);
        ArrayList<String> arrName = new ArrayList<String>();
        for(int i=0;i<20; i++){
            arrName.add("");
        }
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getContext(), R.layout.friend_item,R.id.textView4, arrName);
    ...
    private void setUpActionBar() {
        ...
        actionBar.setCustomView(R.layout.follow_bar);
